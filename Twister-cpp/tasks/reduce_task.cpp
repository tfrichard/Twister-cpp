    ...
    void reduce_task::get_reduce_input(std::string ip_port) {
       ...
       // } else {
        ...
        try {
            ...
            buf = new char[reduce_input_size + 1];
            memset(buf, 0, reduce_input_size + 1);
